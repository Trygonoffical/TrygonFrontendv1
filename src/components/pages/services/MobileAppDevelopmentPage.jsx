    ...
    <div className="min-h-screen">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
              Our Development <span className="text-blue-600">Process</span> 1
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            {process.map((item, index) => (
              ...
              >
                ...
                <div className="flex-1 flex justify-center">
                  <div className="w-64 h-48 mt-3 rounded-lg flex items-center justify-center">
                    {/* <FaMobile className="w-16 h-16 text-blue-600" /> */}
                    {/* <Image src={item.imgLink} alt={item.title} width={200} height={200} /> */}
                    {item.imgLink && <Image src={item.imgLink} alt={item.title} width={200} height={200} />}
                  </div>
                </div>
              </motion.div>
            ))}
